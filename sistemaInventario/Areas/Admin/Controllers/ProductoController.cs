...
namespace SistemaInventario.Areas.Admin.Controllers
{
    ...
    public class ProductoController : Controller
    {
        ...
        public ProductoController(IUnidadTrabajo unidadTrabajo, IWebHostEnvironment webHostEnvironment) // Este codigo nos permite acceder al directorio root donde estan las imagenes
        {
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            if (productoDb == null)
            {
                return Json(new { success = false, message = "Error al Borar Producto" });
